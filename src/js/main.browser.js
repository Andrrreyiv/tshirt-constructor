...
import { validateConfig } from './core/ConfigLoader.js?v=20260826a';
import { TshirtApp } from './ui/TshirtApp.js?v=20260826a';
import { applyTshirtAdmin, applyPrintsOverride } from './tshirt/AdminOverrides.js?v=20260826a';
import { applyZonesOverride, applyCropsOverride, applyStageOverride, applyChildZonesOverride } from './tshirt/AdminOverrides.js?v=20260826a';
import { initTshirtZoneEditor } from './tshirt/zone-editor.browser.js?v=20260826a';

// Версия и у данных: без неё браузер отдавал старый конфиг из кеша, и правки не доезжали.
const CONFIG_URL = 'src/config/tshirt-mock-config.json?v=20260826a';
...
async function boot() {
  ...
  let manifest = null;
  try {
    const mres = await fetch('src/config/prints-manifest.json?v=20260826a');
