...
import { TshirtApp } from './ui/TshirtApp.js?v=20260731c';
import { applyTshirtAdmin, applyPrintsOverride } from './tshirt/AdminOverrides.js?v=20260731c';
import { applyZonesOverride, applyCropsOverride } from './tshirt/AdminOverrides.js?v=20260731c';
import { initTshirtZoneEditor } from './tshirt/zone-editor.browser.js?v=20260731c';

// Версия и у данных: без неё браузер отдавал старый конфиг из кеша, и правки не доезжали.
const CONFIG_URL = 'src/config/tshirt-mock-config.json?v=20260731c';
...
async function boot() {
  ...
  let manifest = null;
  try {
    const mres = await fetch('src/config/prints-manifest.json?v=20260731c');
