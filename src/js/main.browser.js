...
import { validateConfig } from './core/ConfigLoader.js?v=20260825b';
import { TshirtApp } from './ui/TshirtApp.js?v=20260825b';
import { applyTshirtAdmin, applyPrintsOverride } from './tshirt/AdminOverrides.js?v=20260825b';
import { applyZonesOverride, applyCropsOverride, applyStageOverride, applyChildZonesOverride } from './tshirt/AdminOverrides.js?v=20260825b';
import { initTshirtZoneEditor } from './tshirt/zone-editor.browser.js?v=20260825b';

// Версия и у данных: без неё браузер отдавал старый конфиг из кеша, и правки не доезжали.
const CONFIG_URL = 'src/config/tshirt-mock-config.json?v=20260825b';
...
async function boot() {
  ...
  let manifest = null;
  try {
    const mres = await fetch('src/config/prints-manifest.json?v=20260825b');
